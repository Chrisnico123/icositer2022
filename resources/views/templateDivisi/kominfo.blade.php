        ...
        <div class="row text-center">
            <div class="row g-2 g-md-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <p class="jabatan">Kepala Sub Divisi Publikasi<br> TSE'20</br></p>
                ...
                <div class="col-12 col-md-6">
                    <h2 class="nama">Rahman Pajri</h2>
                    <img src="{{ asset('assets') }}/images/avatar-organigram.png">
                    <p class="jabatan">Kepala Sub Divisi Content Creator<br> TSE'20</br></p>
                    <div class="text-center">
                        <button type="button" class="btn btn-success">Staff</button>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <h2 class="nama">Rahman Pajri</h2>
                    <img src="{{ asset('assets') }}/images/avatar-organigram.png">
                    <p class="jabatan">Kepala Sub Divisi Dokumentasi<br> TSE'20</br></p>
                    <div class="text-center">
                        <button type="button" class="btn btn-success">Staff</button>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <h2 class="nama">Rahman Pajri</h2>
                    <img src="{{ asset('assets') }}/images/avatar-organigram.png">
                    <p class="jabatan">Kepala Sub Divisi Desain Digital<br> TSE'20</br></p>
                    <div class="text-center">
                        <button type="button" class="btn btn-success">Staff</button>
                    </div>
                </div>
