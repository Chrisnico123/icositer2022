...
@section('page2')
<form class="row g-3" method="POST" action={{ route('lomba1_page3') }}>
  @csrf
    <div class="nav">
        <div class="name">
            <h1>LKTI</h1>
        ...
        <div class="close">
            <a href="/lomba1/page1"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
