    ...
    <form class="row g-3" method="post" enctype="multipart/form-data" action="{{ route('lomba2s_page1') }}">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="email_ketua" class="form-control @error('email_ketua') is-invalid @enderror"
                value="{{ old('email_ketua', $lomba2s->email_ketua ?? '') }}" id="inputEmail4" placeholder="Masukkan Email">
            @error('email_ketua')
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="nama_tim" class="form-control @error('nama_tim') is-invalid @enderror"
                value="{{ old('nama_tim', $lomba2s->nama_tim ?? '') }}" id="inputPassword4" placeholder="Masukkan Nama tim">
            @error('nama_tim')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-12">
            ...
            <input type="text" name="asal_pt" class="form-control @error('asal_pt') is-invalid @enderror"
                value="{{ old('asal_pt', $lomba2s->asal_pt ?? '') }}" id="inputAddress" placeholder="Asal Perguruan Tinggi">
            @error('asal_pt')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-12">
            ...
            <input type="text" name="nama_ketua" class="form-control @error('nama_ketua') is-invalid @enderror"
                value="{{ old('nama_ketua', $lomba2s->nama_ketua ?? '') }}" id="inputAddress2"
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="prodi_ketua" class="form-control @error('prodi_ketua') is-invalid @enderror"
                value="{{ old('prodi_ketua', $lomba2s->prodi_ketua ?? '') }}" id="inputCity"
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="nim_ketua" class="form-control @error('nim_ketua') is-invalid @enderror"
                value="{{ old('nim_ketua', $lomba2s->nim_ketua ?? '') }}" id="inputState" placeholder="Masukkan NIM Ketua">
            @error('nim_ketua')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-md-2">
            ...
            <input type="number" name="no_wa" class="form-control @error('no_wa') is-invalid @enderror"
                value="{{ old('no_wa', $lomba2s->no_wa ?? '') }}" id="inputZip" placeholder="Masukkan No Whatsapp Ketua">
            @error('no_wa')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
