    ...
    <div class="cont">
        ...
        <div class="card text-center" style="width: 50rem;">
            <div class="card-body">
                ...
                <p class="card-text">LKTI atau Lomba Karya Tulis Ilmiah merupakan Sebuah Lomba yang diselenggarakan di acara
                    ICoSITeR Tahun 2022, yang memiliki tujuan untuk memberikan ide yang kreatif dan solutif untuk
        ...
        <div class="card text-center" style="width: 50rem;">
            <div class="card-body">
                ...
                <p class="card-text">Perlombaan Desain Poster ICoSITeR 2022 adalah sebagai wadah untuk memfasilitasi
        ...
        <div class="card text-center" style="width: 50rem;">
            <div class="card-body">
                ...
                <p class="card-text">"<i>Prototype of Scientific Innovation (Prototype)</i>" merupakan sebuah lomba yang
